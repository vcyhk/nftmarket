...
contract NFTMarket is ReentrancyGuard {
    ...
    function createMarketItem(
        ...
        require(price > 0, "Price cannot be above zero");
        require(
        ...
        idMarketItem[itemId] = MarketItem(
            ...
            payable(address(0)), // set owner to empty
            price,
            false
        );

        //transfer owner to contract
        ...
        nonReentrant
    {
        ...
        idMarketItem[itemId].owner = payable(msg.sender); // set buyer as new owner
    ...
    function fetchMarketItems() public view returns (MarketItem[] memory) {
        uint itemCount = _itemIds.current(); //total no. of created item
        uint unsoldItemCount = _itemIds.current() - _itemSold.current(); //total unsold no.
        uint currentIndex = 0;
